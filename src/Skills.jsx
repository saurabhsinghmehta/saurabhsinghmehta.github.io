...
const Skills = () => {
  ...
  const color = useColorModeValue("#e9a221");
      ...
      >
          ...
          <VStack gap={"10px"}>
            ...
            {(bg === "white" ? frontendBlue : frontendYellow).map((elem) => {
              return (
                ...
                >
                  {" "}
                  <Img width={"11%"} src={elem.image} alt={elem.alt} />{" "}
                  <Text fontSize={"xl"}> {elem.alt} </Text>{" "}
                </Box>
              );
            })}
          </VStack>
        ...
        <Fade top cascade>
          <VStack gap={"10px"}>
            ...
            {(bg === "white" ? commnuicationsBlue : commnuicationsYellow).map(
              (elem) => {
                return (
                  <Box
                    borderColor={bg}
